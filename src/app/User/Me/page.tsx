        ...
        <section className="flex items-center justify-center p-4">
            ...
            <div className="bg-secondary p-4 rounded-xl shadow-lg flex flex-col gap-4">
                ...
                <div className="bg-gray-400 p-4 flex flex-col rounded-xl gap-4 shadow-lg">
                    ...
                    {!idDefaultAddress && (
                        <div className={configDivUserData}>
                           <h1 className={`${configUserData} text-center`} >No hay Direcciones Registradas</h1>
                        </div>
                    )}
                ...
                <div className="flex justify-center">
                    <Button variant="none" href="/User/UpdateUser" className={`scale-100 hover:scale-105 ${configButtonUpdate}`} >Modificar Datos</Button>
                </div> 
            </div> 
            )}
        </section>
